...
import type { SearchResult, LanguageCode } from '@aether/contracts';
...
export const SuggestionList: React.FC<Props> = ({ results, onSelect, onClose }) => {
    ...
    const getText = useCallback((item: SearchResult) => {
    ...
    }, [results, selectedIndex, viewLang, onSelect, onClose, handleSelect]);
