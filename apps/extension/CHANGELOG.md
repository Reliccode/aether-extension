...
- 6b0621a: Set up Changesets and capture the monorepo migration + knowledge cache work for the next version bump.
- dd5b04c: Add mock Notion pull script + knowledge pack summary, context pinning with audit logging for secret reveals, and options UI showing knowledge sync status.

### Patch Changes

- Updated dependencies [6b0621a]
- Updated dependencies [dd5b04c]
  - @aether/core@0.1.0
  - @aether/contracts@0.1.0
